    ...
    <div class="container mx-auto mt-5">
        ...
        <form action="/configs" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="from_domain_url" id="from_url"
                    class="mt-1 block w-full border p-3 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50"
                    required>
            </div>
            <div class="mb-4">
                <label for="to_url" class="block text-sm font-medium text-gray-700">To URL</label>
                <input type="text" name="to_domain_url" id="to_url"
                    class="mt-1 block w-full border p-3 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50"
                    required>
            </div>
